...
addkey("n", "<tab>", "<CMD>bn<CR>", { desc = "Next buffer" })
addkey("n", "<S-tab>", "<CMD>bp<CR>", { desc = "Previous buffer" })
...
addkey("n", "<Leader>d", "<CMD>cd %:p:h<CR>", { desc = "Chdir" })
...
addkey("n", "<Leader>zk", function()
	edit_file("/lua/keymaps.lua")
